...
- Effects proof must include sustained native and LiveScript rendering, intended layer depth, audio transients, live Monitor traffic, effect/script switching, persistence across reboot, invalid-script rejection, both OTA routes, and the final curated-preset soak.
